...
4. Invoke @critic sub-agent to review the implementation against @PLAN.md and capture the returned task_id
...
7. Commit all changes to your assigned worktree branch
